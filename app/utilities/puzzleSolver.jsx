export function NPuzzleSolver(toSolve) {
  this.grid = []
  this.fixed = []
  this.numbers = []
  this.solution = []
...
NPuzzleSolver.prototype.solveRow = function(size) {
  ...
  if (this.numbers[secondToLast].x!== this.grid.length - 1 || this.numbers[secondToLast].y !== rowNumber || this.numbers[last].x !== this.grid.length - 1 || this.numbers[last].y !== rowNumber + 1) {
